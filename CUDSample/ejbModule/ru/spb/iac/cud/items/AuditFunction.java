...
@XmlType(name = "userFunctions", propOrder = {
    "codeFunction",
    "dateFunction",
    "detailsFunction"
})
public class AuditFunction {
	...
	@XmlElement(name = "codeFunction", required=true/*, namespace = "http://audit.services.cud.iac.spb.ru/"*/)
	private String codeFunction;
	
	@XmlElement(name = "dateFunction", required=true/*, namespace = "http://audit.services.cud.iac.spb.ru/"*/)
	private Date dateFunction;
	
	@XmlElement(name = "detailsFunction"/*, namespace = "http://audit.services.cud.iac.spb.ru/"*/)
